...
2. Students are able to interpret and understand statistical outputs from the R package [vegan]{style="font-family: monospace; background-color: #404040;"}.
...
set_flextable_defaults(theme_fun = "theme_vader", font.size = 9)
```
...
2. We convert the column [Site]{style="font-family: monospace; background-color: #404040;"} to a *factor* (categorical information in R)
...
To assess similarity in the [vegan]{style="font-family: monospace; background-color: #404040;"} **R** package carry out the following steps. The
...
background-color: #404040;"} function. We need to specify an input matrix of
...
monospace; background-color: #404040;"} and [distance =]{style="font-family:
monospace; background-color: #404040;"} options. The dissimilarity matrix is
calculated within the [metaMDS()]{style="font-family: monospace;
background-color: #404040;"} function, so for consistency we set [distance =
"jaccard"]{style="font-family: monospace; background-color: #404040;"}.
...
the function [wcmdscale()]{style="font-family: monospace; background-color: #404040;"}.
...
output object 
([AF_pco_all]{style="font-family: monospace; background-color: #404040;"}).
...
In the [vegan]{style="font-family: monospace; background-color: #404040;"}
package, 
the [adonis2()]{style="font-family: monospace; background-color: #404040;"}
function implements Permutational Multivariate Analysis of Variance Using
Distance Matrices (*i.e*. PERMANOVA).

We use a formula in the [adonis2()]{style="font-family: monospace; background-color: #404040;"} function which expresses the community matrix 
...
background-color: #404040;"} indicating a significant effect of location on the
community composition of our samples. Note that 9999 permutations were
undertaken to arrive at this value.

The output from the [pairwise.adonis2()]{style="font-family: monospace; background-color: #404040;"} function is quite lengthy (to see it, run 
[print(AF_PWpermanova_all)]{style="font-family: monospace; background-color: #404040;"}). We can tidy it up for clarity with a custom function ([plainPW()]{style="font-family: monospace; background-color: #683838;"} -- see below).
...
You can also get the [plainPW()]{style="font-family: monospace;"} function code
at [github.com/Ratey-AtUWA/.../FUN_plain_pairwise.R](https://github.com/Ratey-AtUWA/eDNA/raw/master/FUN_plain_pairwise.R).
...
<span style="font-size:9pt">Created with [rmarkdown]{style="font-family: monospace; background-color: #404040;"} in RStudio using the cyborg theme from Bootswatch via the [bslib]{style="font-family: monospace; background-color: #404040;"} package.</span>

...
The output from the [pairwise.adonis2()]{style="font-family: monospace; background-color: #e8e8e8;"} function is quite lengthy (to see it, run 
[print(AF_PWpermanova_all)]{style="font-family: monospace; background-color: #e8e8e8;"}). We can tidy it up for clarity with a custom function ([plainPW()]{style="font-family: monospace; background-color: #f8c8f8;"} -- see below).
